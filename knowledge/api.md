...
offers it. See `knowledge/analytics-and-feeds.md`.
...
- **`peaks.files.index`** in media responses: URL of the peaks JSON sidecar, served for encoded
  audio medias. Format, per-track variants and what to do with it: `knowledge/player.md`,
